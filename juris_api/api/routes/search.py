...
async def search_jurisprudence(
    ...
    tipo_documento: Optional[str] = Query(default=None, description='Filtro opcional. Valores usuais: acordao, decisao_monocratica, sentenca, despacho, processo, movimentacao.'),
